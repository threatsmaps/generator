...
run_single_attack_wget:
	...
	python streaming/stats.py stats.txt ../../output/perf-wget-attack-$(attack-type)-$(number)-s-2000-h-3-w-450-i-2000.txt 2000
	rm stats.txt
