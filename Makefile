...
sdebug: CPPFLAGS += -DSKETCH_SIZE=2000 -DK_HOPS=3 -DPREGEN=100000 -DMEMORY=0 -DDEBUG -g
...
run_wget_2:
	...
	number=0 ; while [ $$number -le 124 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/train/base/base-wget-$$number.txt niters 10000 stream_file ../../data/train/stream/stream-wget-$$number.txt decay 450 lambda 0.02 window 450 interval 1000 multiple 1 sketch_file ../../data/train_wget/sketch-wget-$$number.txt chunkify 1 chunk_size 5 ; \
