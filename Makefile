...
run_wget_2:
	...
	number=0 ; while [ $$number -le 124 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/train/base/base-wget-$$number.txt niters 10000 stream_file ../../data/train/stream/stream-wget-$$number.txt decay 450 lambda 0.02 window 450 interval 3000 sketch_file ../../data/train_wget/sketch-wget-$$number.txt chunkify 1 chunk_size 5 ; \
