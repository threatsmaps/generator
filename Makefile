...
sdebug: CPPFLAGS += -DSKETCH_SIZE=4000 -DK_HOPS=3 -DPREGEN=10000 -DMEMORY=1 -DDEBUG -g
...
run_wget:
	...
	number=0 ; while [ $$number -le 109 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/benign/base/base-wget-$$number.txt niters 10000 stream_file ../../data/benign/stream/stream-wget-$$number.txt decay 450 lambda 0.02 window 2000 interval 3000 sketch_file ../../data/train_wget/sketch-wget-$$number.txt chunkify 1 chunk_size 5 ; \
...
run_wget_baseline_attack_subset:
	...
	mv ../../data/train_wget/sketch-wget-8.txt ../../data/test_wget_baseline
	mv ../../data/train_wget/sketch-wget-20.txt ../../data/test_wget_baseline
	mv ../../data/train_wget/sketch-wget-40.txt ../../data/test_wget_baseline
...
camflow_shellshock_subset:
	cd ../../data/shellshock-apt && mkdir -p train_sketch && mkdir -p test_sketch
	number=0 ; while [ $$number -le 124 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/shellshock-apt/train/base/base-shellshock-benign-$$number.txt niters 100000 stream_file ../../data/shellshock-apt/train/stream/stream-shellshock-benign-$$number.txt decay 500 lambda 0.02 window 8000 interval 16000 sketch_file ../../data/shellshock-apt/train_sketch/sketch-benign-$$number.txt chunkify 1 chunk_size 5 ; \
		rm -rf ../../data/shellshock-apt/train/base/base-shellshock-benign-$$number.txt.* ; \
		rm -rf ../../data/shellshock-apt/train/base/base-shellshock-benign-$$number.txt_* ; \
		number=`expr $$number + 4` ; \
	done
	number=0 ; while [ $$number -le 24 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/shellshock-apt/test/base/base-shellshock-attack-$$number.txt niters 100000 stream_file ../../data/shellshock-apt/test/stream/stream-shellshock-attack-$$number.txt decay 500 lambda 0.02 window 8000 interval 16000 sketch_file ../../data/shellshock-apt/test_sketch/sketch-attack-$$number.txt chunkify 1 chunk_size 5 ; \
		rm -rf ../../data/shellshock-apt/test/base/base-shellshock-attack-$$number.txt.* ; \
		rm -rf ../../data/shellshock-apt/test/base/base-shellshock-attack-$$number.txt_* ; \
		number=`expr $$number + 5` ; \
	done
...
spade_apt_subset:
	cd ../../data/spade-wget-apt && mkdir -p train_sketch && mkdir -p test_sketch
	number=0 ; while [ $$number -le 124 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/spade-wget-apt/train/base/base-spade-benign-$$number.txt niters 100000 stream_file ../../data/spade-wget-apt/train/stream/stream-spade-benign-$$number.txt decay 500 lambda 0.02 window 3000 interval 6000 sketch_file ../../data/spade-wget-apt/train_sketch/sketch-benign-$$number.txt chunkify 1 chunk_size 5 ; \
		rm -rf ../../data/spade-wget-apt/train/base/base-spade-benign-$$number.txt.* ; \
		rm -rf ../../data/spade-wget-apt/train/base/base-spade-benign-$$number.txt_* ; \
		number=`expr $$number + 4` ; \
	done
	number=0 ; while [ $$number -le 24 ] ; do \
		bin/streaming/main filetype edgelist file ../../data/spade-wget-apt/test/base/base-spade-attack-$$number.txt niters 100000 stream_file ../../data/spade-wget-apt/test/stream/stream-spade-attack-$$number.txt decay 500 lambda 0.02 window 3000 interval 6000 sketch_file ../../data/spade-wget-apt/test_sketch/sketch-attack-$$number.txt chunkify 1 chunk_size 5 ; \
		rm -rf ../../data/spade-wget-apt/test/base/base-spade-attack-$$number.txt.* ; \
		rm -rf ../../data/spade-wget-apt/test/base/base-spade-attack-$$number.txt_* ; \
		number=`expr $$number + 5` ; \
	done
